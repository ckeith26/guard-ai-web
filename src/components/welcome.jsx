...
function Welcome() {
  return (
    <div className="App">
      <Header 
        title="GUARD-AI: Governance and Untrusted Action Runtime Defense for AI Agents"
        img='https://1000logos.net/wp-content/uploads/2022/10/Dartmouth-College-Logo.png'
        authors={[
          "Cameron Keith, Ryan Rocha, and Vikram Chetnani", 
